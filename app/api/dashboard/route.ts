...
const supabaseUrl =
  ...
  "https://vqvgvmlblaarrtuiadhj.supabase.co";

const supabaseKey =
  process.env.SUPABASE_SERVICE_ROLE_KEY ||
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ||
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZxdmd2bWxibGFhcnJ0dWlhZGhqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODI1NjA1ODQsImV4cCI6MjA5ODEzNjU4NH0.Rw2SU9PoektFKznTaGIASFkSr_Es4DVg9m4q0fGNv04";
...
export async function GET(req: Request) {
  try {
    ...
    try {
      ...
      console.warn(
        "UploadedFiles table query skipped or failed:",
        e
      );
    }
