...
export default function AdminDashboard({
  ...
  const requests = data?.recentActivity || [];
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ color: "#2d2d2d", margin: 0 }}>
          Good Morning, Admin 👋
        </h1>
      ...
      <div className="stats" style={{ width: "100%" }}>
        <div
          ...
          style={{
            ...
            boxShadow: "0 10px 30px rgba(255, 101, 163, 0.08)",
            borderRadius: "20px",
          }}
        >
      ...
      >
        <div
          ...
          style={{
            ...
            padding: "30px",
            borderRadius: "20px",
            boxShadow: "0 15px 35px rgba(255, 101, 163, 0.08)",
            border: "1px solid rgba(255, 101, 163, 0.2)",
            boxSizing: "border-box",
          }}
        >
          ...
          >
            ...
            {" - "}
            {Math.min(endIndex, requests.length)} of {requests.length} requests
          </p>
            ...
            >
              <thead>
                ...
                >
                  ...
                  <th style={{ padding: "16px" }}>Message / Description</th>
              ...
              <tbody>
                {paginatedRequests.map((item: any) => (
                  <tr
                    key={item.id}
                    style={{ borderBottom: "1px solid #f8f1f5" }}
                  >
                    <td
                      style={{
                        padding: "22px 16px",
                      ...
                      >
                        {item.status !== "Completed" && (
                          <button
                            ...
                            style={{
                              background:
                                "linear-gradient(135deg, #ff65a3 0%, #b174ff 100%)",
                              color: "white",
                              border: "none",
                              padding: "8px 16px",
                              borderRadius: "8px",
                              ...
                              fontSize: "0.9rem",
                              boxShadow:
                                "0 4px 12px rgba(255, 101, 163, 0.2)",
                            }}
                          >
                            Done
                          </button>
            ...
            >
              <button
                ...
                style={{
                  ...
                  color: currentPage === 1 ? "#9ca3af" : "#ff65a3",
                  border: "1px solid #ffd1e3",
                  padding: "10px 18px",
                  borderRadius: "8px",
                  cursor:
